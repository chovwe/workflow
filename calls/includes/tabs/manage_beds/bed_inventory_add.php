...
<form name="frm_new_bed" id="frm_new_bed" method="post">
    <div class="outter_pad">
        <div class="l_float percent50">
            <div class="inner_pad">
                <div class="fieldset">
                    <div class="legend">New Bed Details:</div>
                    <table class="visible_table">
                        ...
                        <tr>
                            <td>Bed Type:</td>
                            <td><?php Form::selectbox($option->dropdown_list('bed_type'),'bed_type'); ?></td>
                        </tr>
                    </table>
                    <!-- Tooltip -->
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        // Form        
        $("#frm_new_bed").on('submit', function($this)
        {
            ...
            if ($no_error)
            {
                ...
                formData.append('sub_opt', 'insert_bed_inventory');
