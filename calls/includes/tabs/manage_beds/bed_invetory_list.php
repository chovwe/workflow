            ...
            <div class="fieldset">
                ...
                <table class="datatable visible_table">
                    ...
                    <?php
                        ...
                        {
                            $bed_inventorys = $bed_inventory->fetch_all();
                            if($bed_inventorys)
                            {
                                foreach($bed_inventorys as $entry)
                                {
                                    echo "<tr>";
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $(".datatable tr td a.bed_inventory").on('click', function(e){
           ...
           $file_loader.load_middle_pane('manage_beds/ward_display', {bed_inventory_id:bed_inventory_id} )
        });
