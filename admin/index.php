                            ...
                            <table class="invisible_table">
                                <tr>
                                    <td style="vertical-align: middle;padding-right:10px;">
                                        <?php $profile = Int_Profile::who_am_i($session->user_id); ?>
                                        <button type="button" name="logged_in_user_btn" id="logged_in_user_btn">
                                            
                                            <?php 
                                                $pix = new Document();
                                                if($pix instanceof Document)
                                                {
                                                    $doc = $pix->fetch_thumb_by_int_profile_id($profile['int_profile_id']);
                                                    if("" != $doc->filename)
                                                    {
                                                        echo '<img src="'.$doc->path.$doc->filename.'" class="rnd_oooo" style="border-radius:5px; margin: -2px 0px 0px -4px;" height="30" width="32px" alt="" />';
                                                    }else{
                                                        echo '<img src="../calls/images/patients/sample.jpg" class="rnd_oooo" height="30" width="32px" alt="" />';
                                                    }
                                                }
                                            ?>
                                        </button>
